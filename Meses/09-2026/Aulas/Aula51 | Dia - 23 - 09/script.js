...
function irParaResumo() {
  ...
  // TROCA DE TELA — esconde produtos, mostra resumo
...
// Zera tudo e volta para tela inicial
function novoPedido() {
  qtdHamburguer = 0;
  qtdBatata = 0;
  qtdRefri = 0;

  document.getElementById("qtd-hamburguer").value = 0;
  document.getElementById("qtd-batata").value = 0;
  document.getElementById("qtd-refri").value = 0;
